...
// Lazy load pages
const PageHome = lazy(() => import('../pages-react/Home'));
const PageNews = lazy(() => import('../pages-react/News'));
const PageArticleDetail = lazy(() => import('../pages-react/ArticleDetail'));
const PageRadioPortal = lazy(() => import('../pages-react/RadioPortal'));
const PageRadioDetail = lazy(() => import('../pages-react/RadioDetail'));
const PageSports = lazy(() => import('../pages-react/Sports'));
const PageLiveTV = lazy(() => import('../pages-react/LiveTV'));
const PageFinance = lazy(() => import('../pages-react/Finance'));
const PageIslamiyat = lazy(() => import('../pages-react/Islamiyat'));
const PageHoroscope = lazy(() => import('../pages-react/Horoscope'));
const PageAbout = lazy(() => import('../pages-react/About'));
const PageContact = lazy(() => import('../pages-react/Contact'));
const PagePrivacyPolicy = lazy(() => import('../pages-react/PrivacyPolicy'));
const PageTermsOfService = lazy(() => import('../pages-react/TermsOfService'));
const PageProfile = lazy(() => import('../pages-react/Profile'));
const PageSettings = lazy(() => import('../pages-react/Settings'));
const PageSitemap = lazy(() => import('../pages-react/Sitemap'));

const pages: Record<string, React.ComponentType<any>> = {
  Home: PageHome,
  News: PageNews,
  ArticleDetail: PageArticleDetail,
  Radio: PageRadioPortal,
  RadioPortal: PageRadioPortal,
  RadioDetail: PageRadioDetail,
  Sports: PageSports,
  TV: PageLiveTV,
  LiveTV: PageLiveTV,
  Finance: PageFinance,
  Islamiyat: PageIslamiyat,
  Horoscope: PageHoroscope,
  About: PageAbout,
  Contact: PageContact,
  PrivacyPolicy: PagePrivacyPolicy,
  TermsOfService: PageTermsOfService,
  Profile: PageProfile,
  Settings: PageSettings,
  Sitemap: PageSitemap
};

function NavigationContent({ pageName, initialData, params, url }: { pageName: string, initialData?: any, params?: any, url?: string }) {
...
export default function AppShell({ pageName, url, initialData, lang, ...rest }: any) {
  ...
  return (
    <ReactProviders url={url} lang={params.lang || lang}>
      <NavigationContent pageName={pageName} initialData={initialData} params={params} url={url} />
    </ReactProviders>
  );
}